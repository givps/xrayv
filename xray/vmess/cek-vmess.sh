#!/bin/bash
# =========================================
# Check vmess WS & gRPC Active Logins
# =========================================
RED='\033[0;31m'
NC='\033[0m'
GREEN='\033[0;32m'
...
TMP_IPvmess="/tmp/ipvmess.txt"
LOG_XRAY="/var/log/xray/access.log"

> "$TMP_OTHER"

# Ambil daftar user dari marker #3
mapfile -t data < <(grep -E "^[[:space:]]*#3 " "/usr/local/etc/xray/config.json" | awk '{print $2}')

echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\E[0;41;36m        Vmess Active Users        \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
